...
> **Current development track:** **v4.0.0-rc.2 (Python)**.
>
...
### v4.0.0-rc.2 Python — recommended for validation
...
Current development version: **4.0.0-rc.2**.
