    ...
    for raw in sys.stdin:
        ...
        try:
            if smtp_host and mail_from and mail_to:
                ...
                send_email(smtp_host, smtp_port, smtp_user, smtp_pass, mail_from, mail_to, f"ExaBGP: route {d['action'].upper()} {d['prefix']} (nh {d['nexthop']})", strip_tags(text), smtp_ssl=smtp_ssl, smtp_starttls=smtp_starttls)
        except Exception as e:
